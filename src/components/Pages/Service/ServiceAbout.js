              ...
              <div className="tp-ab-text pt-130 pl-150 p-relative">
                <div className="tp-section-wrapper">
                  <span className="tp-section-subtitle mb-30">
                    ZAŠTITA VAŠIH PRAVNIH INTERESA
                  </span>
                  <h2 className="tp-section-title text-white">
                    ZAŠTITA VAŠIH INTERESA Profesionalno pravno savetovanje i
                    podrška prilagođena vašim potrebama{" "}
                  </h2>
                  <p className="mb-30">
                    Posvećeni smo pružanju stručne pravne podrške i zaštiti
                    vaših pravnih interesa. Sa bogatim iskustvom u oblasti
                    privrede, nudimo pravne usluge koje će Vam pomoći da rješite
                    svoje pravne probleme i postignete svoje ciljeve.
                  </p>
                  <p>
                    Kontaktirajte nas danas kako bismo Vam pružili potrebnu
                    pravnu podršku.
                  </p>

                  <div className="mt-50 mb-130">
                    <Link to="/kontakt" className="tp-btn-white">
                      Kontakt
                      <span>
                        <svg
                          width="22"
