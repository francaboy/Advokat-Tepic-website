    ...
    <>
      <div className="contact-from-section pt-140">
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="ct-info__box text-center pt-50 pb-50 mb-30">
                ...
                <h3 className="ct-info__box-title">Adresa</h3>
                <p className="p-0">
                  Vase Pelagića 2 <br /> Banja Luka, 78000
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="ct-info__box text-center pt-50 pb-50 mb-30">
                ...
                <h3 className="ct-info__box-title">Telefon</h3>
                <p className="p-0">
                  <a href="tel:+38766453611">066/787-105</a> <br />
                  <a href="tel:38751200007">051/200-007</a>
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="ct-info__box text-center pt-50 pb-50 mb-30">
                ...
                <h3 className="ct-info__box-title">E-mail adresa</h3>
                <p className="p-0">
        ...
        <div className="tp-ct-map">
          <iframe
            title="map"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5665.06294632578!2d17.189405177488474!3d44.7699691865854!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475e0317686ec8db%3A0xbe1a1dd0238b16c4!2sVase%20Pelagi%C4%87a%202%2C%20Banja%20Luka%2078000!5e0!3m2!1sen!2sba!4v1708216849845!5m2!1sen!2sba"
            style={{ border: "0" }}
            allowFullScreen=""
            loading="lazy"
