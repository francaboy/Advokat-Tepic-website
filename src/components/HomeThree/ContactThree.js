              ...
              <div className="tp-contact-info pt-180 pb-150 pr-50">
                <div className="tp-section-wrapper p-color-change">
                  ...
                  <h2 className="tp-section-title text-white mb-35">
                    Potrebna Vam je pravna pomoć ili konsultacije?
                  </h2>
                  <p className="">
                    Obratite nam se ako imate bilo kakvo pitanje ili su Vam samo
                    potrebne određene informacije za vaš slučaj.
                  </p>
                  <div className="mt-50">
            ...
            <div className="col-lg-6">
              <div className="tp-contact-form white-bg pt-60 pl-50 pr-50 pb-60">
                <h4 className="tp-contact-form-title">
                  <i className="fal fa-file-edit"></i>Pošaljite upit
                </h4>
                <form action="#">
